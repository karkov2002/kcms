...
RoxyUtils.GetFileIcon = function(path){
  ret = '/fileman/images/filetypes/unknown.png';//'/fileman/images/filetypes/file_extension_' + RoxyUtils.GetFileExt(path).toLowerCase() + '.png';
  if(fileTypeIcons[RoxyUtils.GetFileExt(path).toLowerCase()]){
    ret = '/fileman/images/filetypes/' + fileTypeIcons[RoxyUtils.GetFileExt(path).toLowerCase()];
  }
...
function Directory(fullPath, numDirs, numFiles){
  ...
  this.Select = function(selectedFile){
    ...
    el.children('img.dir').prop('src', '/fileman/images/folder.png');
    this.SetStatusBar();
  ...
  this.SetOpened = function(){
    ...
    if(li.find('li').length < 1)
      li.children('div').children('.dirPlus').prop('src', '/fileman/images/blank.gif');
    else if(this.IsExpanded())
      li.children('div').children('.dirPlus').prop('src', '/fileman/images/dir-minus.png');
    else
      li.children('div').children('.dirPlus').prop('src', '/fileman/images/dir-plus.png');
  };
...
function dragFileOver(){
  $(this).children('img.dir').attr('src', '/fileman/images/folder-green.png');
}
function dragFileOut(){
  $('#pnlDirList').find('img.dir').attr('src', '/fileman/images/folder.png');
}
...
function switchView(t){
  ...
  if(t == 'thumb'){
    $('#pnlFileList .icon').attr('src', '/fileman/images/blank.gif');
