...
function Directory(fullPath, numDirs, numFiles){
  ...
  this.GetHtml = function(){
     ...
     html += '<div><img src="/fileman/images/'+(this.dirs > 0?'dir-plus.png':'blank.gif')+'" class="dirPlus" width="9" height="9">';
     html += '<img src="/fileman/images/folder.png" class="dir"><span class="name">'+this.name+' ('+this.files+')</span></div>';
     html += '</li>';
