...
function FileSelected(file){
   ...
   */
    ...
    let id = $(window.parent.document).find('.select_img').data('id');
    $(window.parent.document).find('#'+id).val(file.fullPath);
    $(window.parent.document).find('#img_preview_'+id+' img').attr('src',file.fullPath);
}
